...
class DemoApplicationTests {
    ...
    void startTask() {
        Long  id = 1L;
        QualityTask qualityTask = qualityTaskService.getById(id);
        //测试枚举值到枚举映射
        assertEquals(TaskStatusEnum.READY,qualityTask.getTaskStatus());
        System.out.println("实体映射查询"+qualityTask.getTaskStatus());
        //测试枚举到枚举值映射
